...
├── filas_mm1.tex          # Artigo em LaTeX (formato IEEE)
├── Figuras/
...
```bash
pdflatex filas_mm1.tex
pdflatex filas_mm1.tex  # segunda passada para referências
```

O arquivo `Figuras/simulacao_mm1.png` deve estar presente antes de compilar.
